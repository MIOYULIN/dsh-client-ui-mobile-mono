...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    [data-dshmu-mobile] > div:nth-child(3) { grid-column: 3; grid-row: 1; }
    ...
    function apply(ctx) {
      ...
      const syncDrawerState = () => {
        ...
        document.body.toggleAttribute("data-dshmu-drawer-open", drawerOpen());
      ...
      const applyMode = () => {
        ...
        if (!frame || !frame.isConnected) {
          ...
          if (drawerMo === null && typeof MutationObserver !== "undefined") {
            ...
            drawerMo.observe(frame, { attributes: true, attributeFilter: ["data-sidebar-collapsed", "data-dshmu-mobile"] });
          }
        }
      ...
      const onKeyDown = (e) => {
        ...
        if (frame !== null && frame.isConnected && drawerOpen()) closeDrawer();
      };
